	...
	public static void main(String[] args) {
		...
		if(status == 0){
			if (income <= 8350)
				...
				tax = 8350 * 0.10 + (33950 - 8350) * 0.15 + (82250 - 33950) * 0.25 + 
				(171550 - 82250) * 0.28 + (372950 - 171550) * 0.33 + (income - 377950)* 0.35;
		}
		else if (status == 1){
			if (income <= 16700)
				tax = income * 0.10;
				...
				tax = 16700 * 0.10 + (67900 - 16700) * 0.15 + (137050 - 67900) * 0.25 + 
				(208850 - 137050) * 0.28 + (372950 - 208850) * 0.33 + (income - 377950)* 0.35;
		}
		else if (status == 2){
			if (income <= 8350)
				tax = income * 0.10;
				...
				tax = 8350 * 0.10 + (33950 - 8350) * 0.15 + (68525 - 33950) * 0.25 + 
				(171550 - 68525) * 0.28 + (income - 171550) * 0.33;
			else
				tax = 8350 * 0.10 + (33950 - 8350) * 0.15 + (68525 - 33950) * 0.25 + 
				(171550 - 68525) * 0.28 + (372950 - 171550) * 0.33 + (income - 377950)* 0.35;
		}
		else if (status == 3){
			if (income <= 11950)
				tax = income * 0.10;
				...
				tax = 11950 * 0.10 + (45500 - 11950) * 0.15 + (117450 - 45500) * 0.25 + 
				(190200 - 117450) * 0.28 + (372950 - 190200) * 0.33 + (income - 377950)* 0.35;
		}
		else {
